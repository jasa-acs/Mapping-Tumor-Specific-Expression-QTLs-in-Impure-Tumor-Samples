...
sams0 = gsub("hetSNP_", "", files)
sams0 = gsub(".txt", "", sams0, fixed=TRUE)

m1 = match(setdiff(sams0, sams), sams0)
d1 = scan("../R_batch3/submit-jobs.sh", what=character(), sep="\n")
cat(d1[m1], file="../R_batch3/submit-jobs-1.sh", sep="\n")
