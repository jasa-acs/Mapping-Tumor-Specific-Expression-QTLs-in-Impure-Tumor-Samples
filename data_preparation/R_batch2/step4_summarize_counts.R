...
couts = matrix(0, nrow=nrow(nTE), ncol=(idx2-idx1+1))
colnames(couts) = sams[idx1:idx2]
...
for(idx in idx1:idx2){
  ...
  couts[mat1[wNotNA],idx-idx1+1] = geneCts[wNotNA]
}

outF = sprintf("gene_counts_%d_%d.txt", idx1, idx2)
